...
export class StatusBarManager {
    ...
    constructor(private projectManager: ProjectManager, initialUpdate: boolean = true) {
        ...
        this.statusBarItem.command = 'kaskad.core.selectProject';
        this.statusBarItem.tooltip = 'Click to select Kaskad project';
        ...
        if (initialUpdate) {
            ...
            // Show loading state
            this.statusBarItem.text = '$(sync~spin) Loading Kaskad...';
    ...
    private updateStatusBar(): void {
        ...
        if (currentProject) {
            ...
            this.statusBarItem.text = '$(server-environment) No Kaskad project selected';
    ...
    async showProjectPicker(): Promise<void> {
        ...
        if (projects.length === 0) {
            vscode.window.showWarningMessage('No running Kaskad projects found');
            return;
        }
        ...
        const selected = await vscode.window.showQuickPick(items, {
            placeHolder: 'Select a Kaskad project',
