 ...
 *
 * Provides Kaskad project management and control tools for AI assistants.
...
export class LanguageModelToolsService {
    ...
    register(context: vscode.ExtensionContext): void {
        console.log('[LanguageModelTools] Registering Kaskad Project Admin Tools...');

        // Project Management Tools
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_list_projects',
        ...
        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_get_project_info...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_get_project_info',
                new GetProjectInfoTool(this.projectManager),
            ),
        );
        ExtensionOutputChannel.info(
            'LanguageModelTools',
            '✅ Registered: kaskad_get_project_info',
        );

        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_set_active_project...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_set_active_project',
                new SetActiveProjectTool(this.projectManager),
            ),
        );
        ExtensionOutputChannel.info(
            'LanguageModelTools',
            '✅ Registered: kaskad_set_active_project',
        );

        // PMON Control Tools
        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_start_project...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_start_project',
                new StartProjectTool(this.projectManager, this.systemTreeProvider),
            ),
        );
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_start_project');

        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_stop_project...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_stop_project',
        ...
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_stop_project');

        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_get_pmon_status...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_get_pmon_status',
                new GetPmonStatusTool(this.projectManager),
            ),
        );
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_get_pmon_status');

        // Manager Control Tools
        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_project_managers...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_project_managers',
                new ListManagersTool(this.projectManager, this.managerTreeProvider),
            ),
        );
        ExtensionOutputChannel.info(
            'LanguageModelTools',
            '✅ Registered: kaskad_project_managers',
        );

        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_start_manager...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_start_manager',
                new StartManagerTool(this.projectManager, this.managerTreeProvider),
            ),
        );
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_start_manager');

        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_stop_manager...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_stop_manager',
        ...
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_stop_manager');

        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_restart_manager...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_restart_manager',
                new RestartManagerTool(this.projectManager, this.managerTreeProvider),
            ),
        );
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_restart_manager');

        // Manager Lifecycle Tools
        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_add_manager...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_add_manager',
        ...
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_add_manager');

        ExtensionOutputChannel.debug('LanguageModelTools', 'Registering kaskad_delete_manager...');
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_delete_manager',
                new DeleteManagerTool(this.projectManager, this.managerTreeProvider),
            ),
        );
        ExtensionOutputChannel.info('LanguageModelTools', '✅ Registered: kaskad_delete_manager');

        ExtensionOutputChannel.debug(
            'LanguageModelTools',
            'Registering kaskad_configure_manager...',
        );
        this.disposables.push(
            vscode.lm.registerTool(
                'kaskad_configure_manager',
                new ConfigureManagerTool(this.projectManager, this.managerTreeProvider),
            ),
        );
        ExtensionOutputChannel.info(
            'LanguageModelTools',
            '✅ Registered: kaskad_configure_manager',
        );
        ...
        console.log('[LanguageModelTools] ✅ Registered 13 Kaskad Project Admin Tools');
    }
